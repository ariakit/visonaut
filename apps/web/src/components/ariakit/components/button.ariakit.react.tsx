...
import { focusHighlight } from "../styles/focus.ts";
import { glider, gliderAnchor, gliderGroup, gliderSeparator } from "../styles/glider.ts";
import { hover } from "../styles/hover.ts";
import { hasLayerBackground, isLayerColor } from "./layer.ariakit.react.tsx";
import * as ak from "@ariakit/react";
import type { VariantProps } from "clava";
import { splitProps } from "clava";

export interface ButtonProps extends ak.ButtonProps, VariantProps<typeof button> {}
...
export interface ButtonGroupProps extends ak.GroupProps, VariantProps<typeof buttonGroup> {}
...
export interface ButtonGliderProps extends ak.RoleProps<"div">, VariantProps<typeof buttonGlider> {}
...
export interface ButtonLabelProps extends ak.RoleProps<"span">, VariantProps<typeof buttonLabel> {}
...
export interface ButtonSlotProps extends ak.RoleProps<"span">, VariantProps<typeof buttonSlot> {}
...
export const button = cv({
  ...
  refine({ variants, setVariants, addClass }) {
    ...
    if (variants.$kind === "bevel" && variants.$border == null && !hasLayerBackground(variants)) {
