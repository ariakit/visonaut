...
import {
  ...
  buttonSeparator,
  buttonSlot,
} from "./button.ariakit.react.tsx";
import { frame } from "./frame.ariakit.react.tsx";
import { gliderCover } from "../styles/glider.ts";
...
export interface TabsProps
  extends
    ...
    Pick<
      TabProviderProps,
      "rtl" | "selectedId" | "setSelectedId" | "defaultSelectedId" | "selectOnMove"
    >,
...
export interface TabListProps extends ak.TabListProps, VariantProps<typeof tabList> {
  tabs?: Array<React.ReactNode | TabProps> | Record<string, React.ReactNode | TabProps>;
}
    ...
    <ak.TabList {...tabList.jsx(variantProps)} {...rest}>
      {Array.isArray(tabs)
        ? tabs.map((tab, index) => {
            ...
            // its cloned entries.
            const key = element.key == null ? `index:${index}` : `key:${element.key}`;
...
export interface TabLabelProps extends ComponentProps<"span">, VariantProps<typeof tabLabel> {}
...
export interface TabSlotProps extends ComponentProps<"span">, VariantProps<typeof tabSlot> {}
...
export interface TabPanelsProps extends ComponentProps<"div">, VariantProps<typeof tabPanels> {}
...
export interface TabGliderProps extends ComponentProps<"div">, VariantProps<typeof tabGlider> {}
