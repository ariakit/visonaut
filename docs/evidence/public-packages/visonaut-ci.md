...
This verifies a CI artifact and a clean consumer, not the eventual release commit. Repeat the exact-source artifact and trusted-publisher checks after the remaining launch gates pass. Neither npm package has been published.
